...
class MainContent(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        ctk.CTkLabel(headings, text="Title", font=(FONT_SANS_SERIF, 14, "bold")).pack(
            side="left", padx=10
        )
    ...
    def create_song_row(self, idx, title, artist, duration):
        ...
        # Icon Hati
        ctk.CTkButton(row, text="♡", width=30, fg_color="transparent", text_color="grey").pack(
            side="right"
        )
        ctk.CTkButton(row, text="D", width=30, fg_color="transparent", text_color="grey").pack(
            side="right"
        )
