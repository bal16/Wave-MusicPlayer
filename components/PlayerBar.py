...
class PlayerBar(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        # Album Art (Kiri)
        self.lbl_art = ctk.CTkLabel(self.album_frame, text="[IMG]", width=100, height=100, fg_color="#333")
        ...
        self.lbl_song_title = ctk.CTkLabel(self.detail_frame, text="Song Title", font=(FONT_SANS_SERIF, 14))
        self.lbl_song_title.pack(pady=0, anchor="w")
        self.lbl_song_artist = ctk.CTkLabel(self.detail_frame, text="Artist Name", text_color="grey")
        self.lbl_song_artist.pack(pady=0, anchor="w")
        
        # Button Like & Dislike 
        self.like_button = ctk.CTkButton(self.album_frame, text="♡", width=30, fg_color="transparent", text_color="grey", border_width=0)
        ...
        # loop button
        self.btn_loop = ctk.CTkButton(self.volume_frame, text="🔁", width=40, fg_color="transparent", border_width=0)
        self.btn_loop.grid(row=0, column=0, pady=20, padx=0)
        
        # volume button
        self.btn_volume = ctk.CTkButton(self.volume_frame, text="🔊", width=40, fg_color="transparent", border_width=0)
        self.btn_volume.grid(row=0, column=1, pady=20, padx=0)
        
        self.volume_slider = ctk.CTkSlider(self.volume_frame, width=100, progress_color="white", button_color="white")
